...
面向游戏策划和配置人员的 Excel 曲线编辑工具。打开 `.xlsx / .xlsm` 工作簿后，选择一个或多个曲线子列，将其可视化为曲线；拖动曲线点、框选、多选、键盘微调，修改会写回 Excel 对应单元格。反过来，在下方表格中手工编辑单元格，曲线也会同步更新。
...
不传参数时，启动后通过“打开”按钮选择文件；传入路径会直接打开该文件。
...
- 双击曲线区或“自动适配视图”恢复视野。
- 右键菜单可设为当前编辑列、隐藏曲线、批量操作、刷新、导出 PNG 等。
